...
describe('contrast.js - WCAG Contrast Calculator', () => {
  describe('getRelativeLuminance', () => {
    ...
    it('should return correct luminance for gray (#808080)', () => {
      expect(getRelativeLuminance('#808080')).toBeCloseTo(0.21556424, 4);
    });
  ...
  describe('checkContrast', () => {
    ...
    it('should return WCAG AA failing result for red (#cc0000) on white', () => {
    ...
    it('should format ratio correctly', () => {
      ...
      expect(ratio.toFixed(2)).toBe('7.00');
    });
  });
  ...
  describe('getBrightnessCategory', () => {
    ...
    it('should classify gray as medium', () => {
      expect(getBrightnessCategory('#808080')).toBe('medium');
    });
  });
  ...
  describe('WCAG AA Examples', () => {
    ...
    it('gray (#333) on white should pass AA but fail AAA', () => {
    ...
    it('red (#cc0000) on white should fail AA', () => {
  ...
  describe('Common Color Combinations', () => {
    const testCases: { fg: string; bg: string; expectedAA: boolean; expectedAAA: boolean; description: string }[] = [
      { fg: '#000000', bg: '#ffffff', expectedAA: true, expectedAAA: true, description: 'Black on white' },
      { fg: '#ffffff', bg: '#000000', expectedAA: true, expectedAAA: true, description: 'White on black' },
      { fg: '#333333', bg: '#ffffff', expectedAA: true, expectedAAA: false, description: 'Dark gray on white' },
      { fg: '#ffffff', bg: '#333333', expectedAA: true, expectedAAA: false, description: 'White on dark gray' },
      { fg: '#808080', bg: '#ffffff', expectedAA: false, expectedAAA: false, description: 'Gray on white (4.54:1)' },
      { fg: '#000080', bg: '#ffffff', expectedAA: true, expectedAAA: false, description: 'Dark blue on white' },
      { fg: '#800000', bg: '#ffffff', expectedAA: false, expectedAAA: false, description: 'Dark red on white' },
      { fg: '#000000', bg: '#c0c0c0', expectedAA: true, expectedAAA: true, description: 'Black on silver' },
    ];
